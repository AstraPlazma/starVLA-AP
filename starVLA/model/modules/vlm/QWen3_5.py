...
class _QWen3_5_VL_Interface(nn.Module):
    ...
    def __init__(self, config: Optional[dict] = None, **kwargs):
        ...
        Following https://huggingface.co/Qwen/Qwen3.5-0.8B

        """
        super().__init__()

        qwenvl_config = config.framework.get("qwenvl", {})
        model_id = qwenvl_config.get("base_vlm", "Qwen/Qwen3.5-0.8B")
    ...
    def build_qwenvl_inputs(self, images, instructions, solutions=None, **kwargs):
        ...
        Follow Oficial Qwen3.5 Instruct format: https://huggingface.co/Qwen/Qwen3.5-0.8B
        """
